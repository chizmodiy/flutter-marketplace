...
class BlockedUserBottomSheet extends StatefulWidget {
  ...
  const BlockedUserBottomSheet({super.key, this.blockReason});
          ...
          Column(
            children: [
              ...
              Container(
                ...
                child: const Center(
                  child: Icon(Icons.block, color: Color(0xFFB42318), size: 20),
                ),
              ),
          ...
          if (_showDetails && widget.blockReason != null) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color(0xFFFFCDC2), width: 1),
              ),
              child: Column(
