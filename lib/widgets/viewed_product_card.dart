...
class ViewedProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        print('DEBUG (ViewedProductCard): Card tapped for product ID: $id');
        ProfileService().addToViewedList(id);
        if (onTap != null) {
          print('DEBUG (ViewedProductCard): Calling onTap callback');
          onTap!();
        } else {
          print('DEBUG (ViewedProductCard): onTap callback is null');
        }
      },
