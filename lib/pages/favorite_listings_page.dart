...
class _FavoriteListingsPageState extends State<FavoriteListingsPage> {
  ...
  Future<void> _toggleFavorite(Product product) async {
    print(
      '_toggleFavorite called for product: ${product.id}, current favorites: $_favoriteProductIds',
    );
    if (_currentUserId == null) return;
    try {
      if (_favoriteProductIds.contains(product.id)) {
        ...
        print(
          'Product ${product.id} removed from favorites. Remaining: ${_filteredProducts.length}',
        );
                ...
                child: _isLoading
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          print(
                            'Building product ${product.id}, isFavorite: $isFavorite',
                          );
                          return Padding(
                            ...
                            child: ProductCardListItem(
                              ...
                              onFavoriteToggle: () {
                                print(
                                  'Favorite toggle called for product: ${product.id}',
                                );
