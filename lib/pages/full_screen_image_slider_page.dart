...
class FullScreenImageSliderPage extends StatefulWidget {
  ...
  final bool
  showNavigation; // Додаємо параметр для показу/приховування навігації
  ...
  @override
  State<FullScreenImageSliderPage> createState() =>
      _FullScreenImageSliderPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColors.primaryColor.withOpacity(
        0.9,
      ), // Darker, slightly transparent primary color
      body: Stack(
        children: [
          // PageView for images
          PageView.builder(
