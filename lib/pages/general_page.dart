...
class _GeneralPageState extends State<GeneralPage> {
  ...
  final GlobalKey<HomeContentState> _homePageKey = GlobalKey<HomeContentState>(
    debugLabel: 'homePageKey',
  );
  // Додаємо GlobalKeys для інших вкладок з контентом
  final GlobalKey<FavoritesPageState> _favoritesKey =
      GlobalKey<FavoritesPageState>(debugLabel: 'favoritesKey');
  final GlobalKey<ViewedContentState> _viewedKey =
      GlobalKey<ViewedContentState>(debugLabel: 'viewedKey');
  ...
  late final List<Widget> _pages = [
    ...
    ChatPage(key: const Key('chatPage'), onChatRead: _checkUnreadMessages),
  ];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        padding: EdgeInsets.fromLTRB(
          ...
          6,
          0,
          MediaQuery.of(context).size.width >= 450 ? 36 : 20,
        ),
