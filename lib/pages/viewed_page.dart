...
class ViewedContentState extends State<ViewedContent> {
  ...
  void initState() {
    super.initState();
    initializeDateFormatting('uk', null); // Initialize for Ukrainian locale
  ...
  Future<void> _loadViewedProducts() async {
    if (_isLoading)
      return; // Removed _hasMore check here as we'll get all IDs at once
    ...
    try {
      ...
      setState(() {
        _products =
            activeProducts; // Directly assign as we're not paginating here based on viewed IDs
        _isLoading = false;
  ...
  void refreshProducts() {
    if (_currentUserId == null)
      return; // Не оновлюємо для неавторизованих користувачів
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Padding(
                                ...
                                child: ViewedProductCard(
                                  ...
                                  onTap: () async {
                                    print(
                                      'DEBUG (ViewedPage): onTap called for product ID: ${product.id}',
                                    );
                                    try {
                                      ...
                                      print(
                                        'DEBUG (ViewedPage): Navigation completed successfully',
                                      );
                                    } catch (e) {
                                      print(
                                        'ERROR (ViewedPage): Navigation failed: $e',
                                      );
                                    }
                                  },
                                ),
