...
class _ListingDetailPageState extends State<ListingDetailPage> {
  ...
  void _showComplaintModal(Listing listing) async {
    // Додаємо async

    final bool? complaintSent = await showModalBottomSheet(
      // Чекаємо результат
      context: context,
      isScrollControlled: true,
      ...
      builder: (context) => Padding(
        ...
        child: ComplaintModal(productId: listing.id),
      ),
    );
      ...
      if (mounted) {
        ...
        showModalBottomSheet(
          ...
          backgroundColor: Colors
              .white, // Змінюємо на непрозорий колір для тестування видимості
          builder: (context) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            backgroundColor: AppColors
                .notificationDotColor, // Використовуємо наявний червоний колір
            duration: const Duration(
              seconds: 4,
            ), // Явно встановлюємо тривалість
          ),
        );
      }
    }
      ...
      if (type == 'whatsapp') {
        ...
        if (contactValue.trim().startsWith('@')) {
          ...
          if (RegExp(r'^\d{7,}$').hasMatch(cleaned)) {
            final e164 = normalizeUaPhone(cleaned);
            final noPlus = e164.replaceAll('+', '');
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        final result = await Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>
                                EditListingPageNew(listing: snapshot.data!),
                          ),
                        );
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(listing.title, style: AppTextStyles.heading1Semibold),
                  ...
                  const SizedBox(height: 16),
                  Text(listing.description, style: AppTextStyles.body1Regular),
                  const SizedBox(height: 16),
                  // Локація
                  ...
                  Padding(
                    ...
                    child: Wrap(
                      ...
                      runSpacing:
                          8.0, // Відстань між рядами, якщо елементи переносяться
                      children: [
                        // Категорія
                        ...
                        // Підкатегорія
                        if (listing.subcategoryName != null &&
                            listing.subcategoryName!.isNotEmpty)
                          Container(
                            padding: const EdgeInsets.symmetric(
                              horizontal: 10,
                              vertical: 6,
                  ...
                  if (listing.phoneNumber != null)
                    ListTile(
                      ...
                      onTap: () =>
                          _launchContact('phone', listing.phoneNumber!),
                  ...
                  if (listing.whatsapp != null)
                    ListTile(
                      ...
                      onTap: () =>
                          _launchContact('whatsapp', listing.whatsapp!),
                      contentPadding: EdgeInsets.symmetric(
                        vertical: 0,
                        horizontal: 16,
                      ),
                  ...
                  if (listing.telegram != null)
                    ListTile(
                      ...
                      onTap: () =>
                          _launchContact('telegram', listing.telegram!),
                      contentPadding: EdgeInsets.symmetric(
                        vertical: 0,
                        horizontal: 16,
                      ),
                  ...
                  if (listing.viber != null)
                    ListTile(
                      ...
                      onTap: () => _launchContact('viber', listing.viber!),
                      contentPadding: EdgeInsets.symmetric(
                        vertical: 0,
                        horizontal: 16,
                      ),
                  ...
                  if (!_isNotMyListing(listing)) const SizedBox(height: 20),
                  // Користувач
                  Text(
                    'Користувач',
