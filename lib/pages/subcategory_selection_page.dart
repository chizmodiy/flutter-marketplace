...
class _SubcategorySelectionPageState extends State<SubcategorySelectionPage> {
  ...
  void initState() {
    ...
    _selectedSubcategory =
        widget.selectedSubcategory; // Set the selected subcategory from widget
    _loadSubcategories();
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  widget
                      .category
                      .name, // Display selected category name as title
              ...
              child: Container(
                ...
                decoration: ShapeDecoration(
                  color: isSelected
                      ...
                      : Colors
                            .transparent, // Zinc-100 for selected, transparent for unselected
