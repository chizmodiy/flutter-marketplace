    ...
    setState(() {
      _filteredProducts = query.isEmpty
          ...
          : _products
                ...
                .toList();
      log(
        'Filtered products count:  [32m[32m${_filteredProducts.length} [0m',
      );
    });
  }
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                            ...
                            child: _InactiveSwipeableCard(
                              isOpened: isOpened,
                              onOpen: () =>
                                  setState(() => _openedActionIndex = index),
          ...
          return SizedBox(
            ...
            child: Stack(
              ...
              children: [
                ...
                SizedBox(height: cardHeight, child: widget.child),
                // Overlay: фон + кнопки
                AnimatedPositioned(
                              ...
                              Container(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (confirmed == true) {
                                      await widget.listingService.deleteListing(
                                        widget.productId,
                                      );
                                      setState(() {
                                        _actionVisible = false;
...
Widget _trySvgOrIcon(
  String asset,
  IconData fallback, {
  Color color = const Color(0xFF27272A),
}) {
  try {
