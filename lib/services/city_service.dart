...
class CityService {
  ...
  Future<List<City>> searchCities(
    ...
    final Map<String, String> params = {
      ...
      'addressdetails': '1',
      'limit':
          '100', // Increased limit to get more results within a bounding box
    ...
    if (query.isNotEmpty) {
      ...
      params['q'] =
          regionName; // This will return the region itself, as observed before
    ...
    try {
      final response = await http.get(
        ...
        headers: {
          'User-Agent':
              'Zeno/1.0 (https://yourwebsite.com/contact)', // Replace with your app contact info
        },
      );
        ...
        for (var item in data) {
          ...
          if (nominatimClass == 'place' &&
              (nominatimType == 'city' ||
                  ...
                  nominatimType == 'hamlet')) {
            isSettlement = true;
          } else if (nominatimClass == 'boundary' &&
              nominatimType == 'administrative' &&
              placeRank != null &&
              placeRank >= 16 &&
              placeRank <= 20) {
